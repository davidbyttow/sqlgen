...
func (o *User) Insert(ctx context.Context, exec sqlgen.Executor, cols ...sqlgen.Columns) error {
	...
	allCols := []string{"email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}
	allVals := []any{o.Email, o.Name, o.Bio, o.Age, o.Score, o.IsAdmin, o.Metadata, o.CreatedAt}
	allCols, allVals = sqlgen.FilterColumns(allCols, allVals, cols...)

	returning := []string{"id", "email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}
...
func (o *User) Update(ctx context.Context, exec sqlgen.Executor, cols ...sqlgen.Columns) error {
	...
	setCols := []string{"email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}
	setVals := []any{o.Email, o.Name, o.Bio, o.Age, o.Score, o.IsAdmin, o.Metadata, o.CreatedAt}
...
func (o *User) Upsert(ctx context.Context, exec sqlgen.Executor, cols ...sqlgen.Columns) error {
	...
	allCols := []string{"id", "email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}
	allVals := []any{o.ID, o.Email, o.Name, o.Bio, o.Age, o.Score, o.IsAdmin, o.Metadata, o.CreatedAt}
	allCols, allVals = sqlgen.FilterColumns(allCols, allVals, cols...)
	conflictCols := []string{"id"}
	updateCols := []string{"email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}
...
func (s UserSlice) InsertAll(ctx context.Context, exec sqlgen.Executor) error {
	...
	cols := []string{"email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}
	returning := []string{"id", "email", "name", "bio", "age", "score", "is_admin", "metadata", "created_at"}

	rows := make([][]any, len(s))
	for i, o := range s {
		rows[i] = []any{o.Email, o.Name, o.Bio, o.Age, o.Score, o.IsAdmin, o.Metadata, o.CreatedAt}
	}
