...
func (o *Post) Insert(ctx context.Context, exec sqlgen.Executor, cols ...sqlgen.Columns) error {
	...
	allCols := []string{"author_id", "category_id", "title", "body", "status", "created_at", "published_at"}
	allVals := []any{o.AuthorID, o.CategoryID, o.Title, o.Body, o.Status, o.CreatedAt, o.PublishedAt}
	allCols, allVals = sqlgen.FilterColumns(allCols, allVals, cols...)

	returning := []string{"id", "author_id", "category_id", "title", "body", "status", "created_at", "published_at"}
...
func (o *Post) Update(ctx context.Context, exec sqlgen.Executor, cols ...sqlgen.Columns) error {
	...
	setCols := []string{"author_id", "category_id", "title", "body", "status", "created_at", "published_at"}
	setVals := []any{o.AuthorID, o.CategoryID, o.Title, o.Body, o.Status, o.CreatedAt, o.PublishedAt}
...
func (o *Post) Upsert(ctx context.Context, exec sqlgen.Executor, cols ...sqlgen.Columns) error {
	...
	allCols := []string{"id", "author_id", "category_id", "title", "body", "status", "created_at", "published_at"}
	allVals := []any{o.ID, o.AuthorID, o.CategoryID, o.Title, o.Body, o.Status, o.CreatedAt, o.PublishedAt}
	allCols, allVals = sqlgen.FilterColumns(allCols, allVals, cols...)
	conflictCols := []string{"id"}
	updateCols := []string{"author_id", "category_id", "title", "body", "status", "created_at", "published_at"}
...
func (s PostSlice) InsertAll(ctx context.Context, exec sqlgen.Executor) error {
	...
	cols := []string{"author_id", "category_id", "title", "body", "status", "created_at", "published_at"}
	returning := []string{"id", "author_id", "category_id", "title", "body", "status", "created_at", "published_at"}

	rows := make([][]any, len(s))
	for i, o := range s {
		rows[i] = []any{o.AuthorID, o.CategoryID, o.Title, o.Body, o.Status, o.CreatedAt, o.PublishedAt}
	}
